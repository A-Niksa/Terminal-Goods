...
public class AccountInfo implements Menu {
    ...
    private final String commandLine = "Main | Login | Customer | Account";
    private final String invalidOption = "ERROR: You have entered an invalid option/command.";
    Scanner scanner;
    Menu previousMenu;
    Customer customer;

    public AccountInfo(Scanner scanner, Menu previousMenu, Customer customer) {
    ...
    public void showAccountInfo(boolean showPassword) {
        String[] accountInfo = customer.returnAccountInfo(showPassword);
        int numberOfFields = 8;
        int width = 20;
        String[] fields = {"Role", "Username", "Password", "First Name", "Last Name", "Birthday", "Age", "Balance"};
